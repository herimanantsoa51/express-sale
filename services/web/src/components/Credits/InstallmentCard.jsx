        ...
        <div className="installment-progress">
          <div className="progress-bar-full">
            <div 
              ...
              style={{ 
                width: `${installment.payment_percentage || 0}%`,
                backgroundColor: (installment.payment_percentage || 0) === 100 ? 'var(--success)' : 'var(--primary)'
              }}
            />
          </div>
          <div className="progress-label">
            {(installment.payment_percentage || 0).toFixed(0)}%
          </div>
        </div>
