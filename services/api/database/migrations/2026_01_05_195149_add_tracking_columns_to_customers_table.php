...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Ajoute les colonnes de tracking pour:
     * - Historique des achats (dates, totaux)
     * - Compteurs de paiements (à temps, retard)
     * - Compteurs de réservations annulées
     *
     * Ces données permettent le calcul automatique du reliability_score
     * et l'analyse comportementale des clients.
     */
