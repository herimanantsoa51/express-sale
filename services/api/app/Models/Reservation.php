...
class Reservation extends Model
{
    ...
    /**
     * Utilisateur (vendeur) ayant créé la réservation
     */
    ...
    /**
     * Items de la réservation (propres, indépendants de Sale)
     */
    ...
    /**
     * Transactions financières liées directement à cette réservation
     */
    ...
    // Accède aux articles réservés (propres, indépendants de Sale)
    ...
    public static function generateNumber(): string
    {
        ...
        if ($lastReservation && preg_match('/-(\d{4})$/', $lastReservation->reservation_number, $matches)) {
            $next = (int) $matches[1] + 1;
        } else {
            $next = 1;
        }

        return sprintf('RSV-%s-%04d', $dateStr, $next);
    }
